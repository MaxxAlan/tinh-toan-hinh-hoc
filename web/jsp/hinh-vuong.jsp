                ...
                <div class="formula-box">
                    ...
                    <ul id="formulaList">
                        ...
                        <li id="fm-s" data-inputs="a">
                            Diện tích: <span class="var-token" data-var="S">S</span> = <span class="var-token" data-var="a">a</span>²
                        </li>
                        <li id="fm-d" data-inputs="a">
                            Đường chéo: <span class="var-token" data-var="d">d</span> = <span class="var-token" data-var="a">a</span>√2
                        </li>
                        <li id="fm-R" data-inputs="a">
                            Bán kính ngoại tiếp: <span class="var-token" data-var="R">R</span> = <span class="var-token" data-var="a">a</span>√2/2
                        </li>
                        <li id="fm-r" data-inputs="a">
                            Bán kính nội tiếp: <span class="var-token" data-var="r">r</span> = <span class="var-token" data-var="a">a</span>/2
                        </li>
                    </ul>
    ...
    <script>
        function watchFormulas() {
            ...
            if (hasA) {
                ...
                ['fm-c','fm-s','fm-d','fm-R','fm-r'].forEach(function(id) {
                    document.getElementById(id).classList.add('formula-ready');
                });
                ['C','S','d','R','r'].forEach(function(v) {
