...
<body>
                ...
                <text id="svgLabelH" x="206" y="115" font-size="11" font-weight="600" fill="#e53e3e">h</text>
                    ...
                    <ul id="formulaList">
                        <li id="fm-v" data-inputs="r,h">
                            Thể tích: <span class="var-token" data-var="V">V</span> = π<span class="var-token" data-var="r">r</span>²<span class="var-token" data-var="h">h</span>
                        </li>
                        <li id="fm-sxq" data-inputs="r,h">
                            Diện tích xung quanh: <span class="var-token" data-var="Sxq">S<sub>xq</sub></span> = 2π<span class="var-token" data-var="r">r</span><span class="var-token" data-var="h">h</span>
                        </li>
                        <li id="fm-stp" data-inputs="r,h">
                            Diện tích toàn phần: <span class="var-token" data-var="Stp">S<sub>tp</sub></span> = 2π<span class="var-token" data-var="r">r</span>(<span class="var-token" data-var="r">r</span> + <span class="var-token" data-var="h">h</span>)
                        </li>
                    </ul>
    ...
    <script>
        function updateSvgShape() {
            ...
            if (has1 && has2) {
                ['fm-v','fm-sxq','fm-stp'].forEach(function(id) { document.getElementById(id).classList.add('formula-ready'); });
                ['V','Sxq','Stp'].forEach(function(v) {
