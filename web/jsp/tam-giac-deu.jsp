                ...
                <text x="125" y="105" font-size="11" fill="#e53e3e">h</text>
                    ...
                    <ul id="formulaList">
                        <li id="fm-c" data-inputs="a">
                            Chu vi: <span class="var-token" data-var="C">C</span> = 3<span class="var-token" data-var="a">a</span>
                        </li>
                        <li id="fm-s" data-inputs="a">
                            Diện tích: <span class="var-token" data-var="S">S</span> = <span class="var-token" data-var="a">a</span>²√3/4
                        </li>
                        <li id="fm-h" data-inputs="a">
                            Chiều cao: <span class="var-token" data-var="h">h</span> = <span class="var-token" data-var="a">a</span>√3/2
                        </li>
                        <li id="fm-R" data-inputs="a">
                            Bán kính ngoại tiếp: <span class="var-token" data-var="R">R</span> = <span class="var-token" data-var="a">a</span>√3/3
                        </li>
                        <li id="fm-r" data-inputs="a">
                            Bán kính nội tiếp: <span class="var-token" data-var="r">r</span> = <span class="var-token" data-var="a">a</span>√3/6
                        </li>
                    </ul>
    ...
    <script>
        function updateSvgShape() {
            ...
            if (has) {
                ...
                ['fm-c','fm-s','fm-h','fm-R','fm-r'].forEach(function(id) { document.getElementById(id).classList.add('formula-ready'); });
                ['C','S','h','R','r'].forEach(function(v) {
