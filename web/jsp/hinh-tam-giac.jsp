...
<body>
        ...
        <div class="calc-grid">
            ...
            <svg viewBox="0 0 240 180" xmlns="http://www.w3.org/2000/svg">
                ...
                <text id="svgLabelH" x="97" y="90" font-size="11" font-weight="600" fill="#e53e3e">h</text>
                    ...
                    <ul id="formulaList">
                        <li id="fm-per" data-inputs="a,b,c">
                        ...
                        <li id="fm-s" data-inputs="a,b,c">
                            Diện tích (Heron): <span class="var-token" data-var="S">S</span> = √(p(p-a)(p-b)(p-c)), p=C/2
                        </li>
    ...
    <script>
        function updateSvgShape() {
            ...
            if(ha&&hb&&hc){
                ['fm-per','fm-s','fm-R','fm-r'].forEach(function(id){document.getElementById(id).classList.add('formula-ready');});
                ['C','S','R','r'].forEach(function(v){document.querySelectorAll('.var-token[data-var="'+v+'"]').forEach(function(el){el.classList.add('var-target');});});
            }
        }
