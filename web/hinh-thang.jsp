...
<body>
    <div class="container">
        ...
        <% } %>
        <form class="calc-form" method="post" action="${pageContext.request.contextPath}/TrapezoidController">
            <div class="form-row">
        ...
        <div class="result-box">
            ...
            <div class="step-detail">
                ...
                <p>\(S = \dfrac{(a + b) \times h}{2} = \dfrac{(${param.a} + ${param.b}) \times ${param.h}}{2} = \) <strong><fmt:formatNumber value="${requestScope.thang.getArea()}" pattern="#,##0.####"/></strong> <span class="unit-badge">đơn vị diện tích</span></p>
            </div>
            <div class="step-detail">
                <p><strong>2. Đường trung bình (m):</strong></p>
                <p>\(m = \dfrac{a + b}{2} = \dfrac{${param.a} + ${param.b}}{2} = \) <strong><fmt:formatNumber value="${requestScope.thang.getMedian()}" pattern="#,##0.####"/></strong> <span class="unit-badge">đơn vị dài</span></p>
            </div>
        </div>
        <% } %>
